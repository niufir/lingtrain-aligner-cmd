...
def processSmallPart(book1:BookConfig,text1_prepared, text2_prepared,
    ...
    validation_info, error_index_log = vis_helper.validHlp_IdsMergeStore(
                                      db_path,
...
def MarkingWrongErrorsItems(db_path, lang_from, lang_to, large_blocks, splitted_from_all):
    stat_err_from_len = 0
    err_perc, ix_list = vis_helper.validHlp_IdsMergeStore(db_path, output_path=None, lang_name_from=lang_from,
